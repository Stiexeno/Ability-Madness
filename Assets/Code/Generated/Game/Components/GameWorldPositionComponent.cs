...
public partial class GameEntity {
    ...
    private AbilityMadness.Code.Common.WorldPosition worldPosition { get { return (AbilityMadness.Code.Common.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    public UnityEngine.Vector3 WorldPosition { get { return worldPosition.Value; } set { worldPosition.Value = value; }}
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (AbilityMadness.Code.Common.WorldPosition)CreateComponent(index, typeof(AbilityMadness.Code.Common.WorldPosition));
    ...
    public GameEntity ReactiveReplaceWorldPosition(UnityEngine.Vector3 newValue) {
        var index = GameComponentsLookup.WorldPosition;
        var component = (AbilityMadness.Code.Common.WorldPosition)CreateComponent(index, typeof(AbilityMadness.Code.Common.WorldPosition));
        component.Value = newValue;
