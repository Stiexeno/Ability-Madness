...
public partial class GameEntity {
    ...
    private AbilityMadness.Code.Common.ViewPath viewPath { get { return (AbilityMadness.Code.Common.ViewPath)GetComponent(GameComponentsLookup.ViewPath); } }
    public string ViewPath { get { return viewPath.Value; } set { viewPath.Value = value; }}
    ...
    public GameEntity AddViewPath(string newValue) {
        ...
        var component = (AbilityMadness.Code.Common.ViewPath)CreateComponent(index, typeof(AbilityMadness.Code.Common.ViewPath));
    ...
    public GameEntity ReactiveReplaceViewPath(string newValue) {
        var index = GameComponentsLookup.ViewPath;
        var component = (AbilityMadness.Code.Common.ViewPath)CreateComponent(index, typeof(AbilityMadness.Code.Common.ViewPath));
        component.Value = newValue;
