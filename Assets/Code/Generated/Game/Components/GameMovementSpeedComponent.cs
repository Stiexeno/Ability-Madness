...
public partial class GameEntity {
    ...
    private AbilityMadness.Code.Gameplay.Movement.MovementSpeed movementSpeed { get { return (AbilityMadness.Code.Gameplay.Movement.MovementSpeed)GetComponent(GameComponentsLookup.MovementSpeed); } }
    public float MovementSpeed { get { return movementSpeed.Value; } set { movementSpeed.Value = value; }}
    ...
    public GameEntity AddMovementSpeed(float newValue) {
        ...
        var component = (AbilityMadness.Code.Gameplay.Movement.MovementSpeed)CreateComponent(index, typeof(AbilityMadness.Code.Gameplay.Movement.MovementSpeed));
    ...
    public GameEntity ReactiveReplaceMovementSpeed(float newValue) {
        var index = GameComponentsLookup.MovementSpeed;
        var component = (AbilityMadness.Code.Gameplay.Movement.MovementSpeed)CreateComponent(index, typeof(AbilityMadness.Code.Gameplay.Movement.MovementSpeed));
        component.Value = newValue;
